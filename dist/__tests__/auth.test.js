...
describe('POST /api/auth/login', () => {
    ...
    describe('Security - SQL Injection Prevention', () => {
        ...
        it.each(sqlInjectionPayloads)('should safely handle SQL injection attempt in email: %s', async (payload) => {
        ...
        it.each(sqlInjectionPayloads)('should safely handle SQL injection attempt in password: %s', async (payload) => {
