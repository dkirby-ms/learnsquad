...
// Mock types for OAuth configuration
...
const mockOAuthService = {
  ...
  // Validate tokens
  validateIdToken(idToken: string): { valid: boolean; payload?: object; error?: string } {
...
const mockSessionStore = {
  sessions: new Map<string, { userId: string; tokens: TokenResponse; createdAt: number }>(),

  create(userId: string, tokens: TokenResponse): string {
