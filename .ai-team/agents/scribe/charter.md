...
5. **Commit `.ai-team/` changes** with proper message format.
...
└── agents/
    ├── holden/history.md  # Holden's personal knowledge
    ├── naomi/history.md   # Naomi's personal knowledge
    ├── amos/history.md    # Amos's personal knowledge
    ├── miller/history.md  # Miller's personal knowledge
    ├── drummer/history.md # Drummer's personal knowledge
    └── ...
```
